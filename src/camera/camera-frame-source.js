...
/**
 * @typedef {object} CameraFrameSourceOptions
 * @property {number} [maxFrameSize] Frames are downscaled so their longest side is at most this
 *   many pixels.
 */

/** @typedef {CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D} Context2D */
/**
 * @typedef {new (message: string, options?: ErrorOptions) => import('../errors.js').Code39ScannerError} CameraErrorClass
 */
 ...
 * @type {ReadonlyMap<string, readonly [CameraErrorClass, string]>}
 */
...
/** @type {readonly [CameraErrorClass, string]} */
...
/**
 * @param {unknown} error
 * @returns {import('../errors.js').Code39ScannerError}
 */
...
/** @param {unknown} [cause] */
const cancelledStart = (cause) => OperationCancelledError.superseded('Camera start', cause);
 ...
 * @param {number} width
 * @param {number} height
 * @returns {import('../types.js').LuminanceSource}
 */
 ...
 * @implements {import('../types.js').FrameSource}
 */
export class CameraFrameSource {
   ...
   * @param {CameraFrameSourceOptions} [options]
   */
   ...
   * `OperationCancelledError`.
   * @param {import('../types.js').StartOptions} [options]
   ...
   * @returns {import('../types.js').LuminanceSource | null}
   */
  grabFrame() {
    const video = this.#video;
